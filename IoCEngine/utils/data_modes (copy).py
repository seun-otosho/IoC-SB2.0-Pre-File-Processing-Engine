    ...
    d = {
        'cmb': {
            ...
            'corpfac': (
                ...
                'consent_d8to',
                'facility_type', 'facility_purpose', 'ownership', 'approved_amt', 'd8_approved', 'currency', 'int_type',
                'int_rate',
        ...
        'mfi': {
            ...
            'fac': (
                'branch_code', 'prev_branch_id', 'account_no', 'prev_acct_no', 'consent_stat', 'consent_d8from',
                'consent_d8to', 'facility_type', 'comments', 'ownership', 'approved_amt', 'currency', 'int_rate',
        ...
        'pmi': {
            ...
            'fac': (
                'branch_code', 'prev_branch_id', 'account_no', 'prev_acct_no', 'consent_stat', 'consent_d8from',
                'consent_d8to',
                'facility_type', 'facility_purpose', 'ownership', 'approved_amt', 'equity_amt', 'd8_approved',
                'currency',
...
def fandl():
    idict = {
        ...
        'corpfac': (
            'branch_code', 'prev_branch_id', 'account_no', 'prev_acct_no', 'consent_stat', 'consent_d8from',
            'consent_d8to', 'facility_type', 'facility_purpose', 'ownership', 'approved_amt', 'd8_approved',
...
def phed():
    return {
        'corpfac': (
            ...
            'consent_d8from', 'consent_d8to', 'facility_type', 'facility_purpose', 'ownership', 'approved_amt',
...
def min_mndtry():
    d = {
        ...
        'ndvdl': (
            ...
            'birth_date', 'gender'),
        'ndvdlfac': (
            'branch_code', 'account_no', 'consent_stat', 'facility_type', 'ownership', 'approved_amt', 'currency',
...
def date_fields():
    f = ('maturity_date', 'litigxn_date', 'int_last_paid_date', 'last_paid_date', 'acct_clsd_date', 'd8_acct_stat',
         ...
         'id_code2d8xpry', 'birth_date', 'i_pass_expiry', 'bvn_d8xpry', 'biz_d8reg',)
    return f
