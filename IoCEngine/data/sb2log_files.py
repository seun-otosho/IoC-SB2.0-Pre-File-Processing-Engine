...
from IoCEngine.data.re_co_mo import copyrecursively
from IoCEngine.commons import count_down
from IoCEngine.data.copy_log_files import process_ftp_files
...
if __name__ == '__main__':
    ...
    # watch_directories(['/media/tolorun/x/x/x/IoC/SB2/logs/logs/09'], f, 1)

    copyrecursively('/media/tolorun/x/x/x/IoC/SB2/logs/logs/09', '/media/tolorun/x/x/x/IoC/SB2/logs/all')
